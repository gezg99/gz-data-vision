...
import { KPICard, ComparisonBar, LineChart, DashboardMockup } from "./TimelineCharts";
...
const CometaSpecialistBlock = () => {
  const impacts = [
    ...
    "One-pagers y control towers de ventas, soporte, AM, onboarding y finanzas",
    "Normalización SIGED–HubSpot (50k+ escuelas limpias)",
    "Data quality, alertas operativas y validaciones automáticas",
    "Insights financieros para founders: drivers reales de rentabilidad, erosión de margen y estrategia de crecimiento"
  ];
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-0 md:left-1/2 top-0 w-4 h-4 bg-primary rounded-full transform -translate-x-1/2 z-10 shadow-lg shadow-primary/50">
      ...
      <div className="grid md:grid-cols-2 gap-6 md:gap-12">
        ...
        >
          <div className="bg-card border border-primary/30 rounded-xl p-6 hover:border-primary/50 transition-colors duration-300 relative overflow-hidden">
            {/* Current role indicator */}
            <div className="absolute top-0 right-0 w-20 h-20 bg-primary/10 rounded-full blur-2xl" />
            
            {/* Header */}
            <div className="flex items-center gap-2 md:justify-end mb-4 relative z-10">
            ...
            <p className="text-sm text-primary font-medium mb-4">2024 – Presente</p>
            
            <p className="text-sm text-muted-foreground leading-relaxed mb-6">
              Transformé la inteligencia operativa y financiera de Cometa creando la capa central de métricas que hoy guía decisiones de founders y equipos. Desarrollé el primer modelo real de margen por colegio, corrigiendo años de errores financieros y redefiniendo la estrategia de pricing, rentabilidad y crecimiento.
            </p>
        ...
        >
          <div className="bg-card/60 border border-border/30 rounded-xl p-5 space-y-5">
            ...
            {/* Margin comparison */}
            <div>
              <p className="text-xs text-muted-foreground mb-3">Margen real vs estimado</p>
              <div className="space-y-2">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-medium w-10 text-right">45%</span>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-xs font-medium text-primary w-10 text-right">72%</span>
                </div>
              </div>
            </div>
            ...
            <LineChart 
              title="Pricing corregido (evolución de precisión)"
            />
            ...
            <div className="bg-background/50 border border-border/30 rounded-lg p-4 text-center">
              ...
              <div className="flex items-center justify-center gap-3">
                <span className="text-lg font-display text-muted-foreground line-through">80h</span>
                <Zap className="w-4 h-4 text-primary" />
                <span className="text-2xl font-display font-bold text-primary">1h</span>
              </div>
              <p className="text-[10px] text-muted-foreground mt-1">por ciclo de análisis</p>
            </div>
          </div>
        </motion.div>
      </div>
